      ...
      <div className="back">
        <div className="etapas">
          ...
          <div className="placaVideo">
            <button type="button" className="btn btn-danger" id="placaVideoButton">
              <img src="https://img.icons8.com/glyph-neue/50/000000/video-card.png" className="imgPC" />
            </button>
            <h5>PLACA DE VÍDEO</h5>
          </div>
          <div className="hdSsd">
            <button type="button" className="btn btn-danger" id="hdSsdButton">
          ...
          <div className="gabinete">
            <button type="button" className="btn btn-danger" id="gabineteButton">
          ...
          <div className="fonte">
            <button type="button" className="btn btn-danger" id="fonteButton">
              <img src="https://img.icons8.com/ios-filled/50/000000/lightning-bolt--v1.png" className="imgPC" />
            </button>
            <h5>FONTE DE ALIMENTAÇÃO</h5>
          </div>
          <div className="final">
            <button type="button" className="btn btn-danger" id="finalButton">
